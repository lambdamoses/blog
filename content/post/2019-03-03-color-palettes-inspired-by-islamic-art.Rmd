...
author: Lambda Moses
date: '2019-03-03'
slug: color-palettes-inspired-by-islamic-art
categories:
  - R
tags:
  - graphics
...
There're many theories, and there isn't one single cause to the demise of the Islamic golden age. Anyway, though the golden age is now lost in history, many artifacts from that era are still available for visit, as tourist attractions or as museum exhibits. That's why I wrote the R package [`IslamicArt`](https://github.com/lambdamoses/IslamicArt). This package can't bring the Islamic golden age back. However, at least it can let us commemorate the history by incorporating color schemes of related historical artifacts, mostly from that period, some earlier and some later, into our statistical graphics. 
